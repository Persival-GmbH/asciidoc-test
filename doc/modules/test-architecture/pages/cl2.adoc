...
[#img-cl2_test_tracefile,link=cl2_test_tracefile.svg]
image::cl2_test_tracefile.svg[Tracefile test setup for CL 2,400]

[.left]
.Esmini test setup for CL 2
image::cl2_test_esmini.svg[Esmini test setup for CL 2,400]
--
