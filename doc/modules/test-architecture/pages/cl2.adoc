...
image::cl2_test_tracefile.svg[Test setups for credibility assessment level 2,400]

.Discrete credibility assessment level
image::cl2_test_esmini.svg[Test setups for credibility assessment level 2,400]


.Discrete credibility assessment level
image::cl2_test_tracefile.svg[] image::cl2_test_esmini.svg[]
